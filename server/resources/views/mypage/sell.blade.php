                ...
                <form action="/sell" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card shadow-none border-0 pb-4">
                        <div class="card-body pt-4">
                            <label class="font-weight-bold">出品画像<span
                        ...
                        <div class="card-body pt-3">
                            ...
                            {{-- 商品名 --}}
                            <label class="font-weight-bold">商品名<span
                                    class="badge badge-danger shadow-none ml-2">必須</span></label>
                        ...
                        <div class="card-body">
                            ...
                            {{-- 商品説明 --}}
                            <label class="font-weight-bold">商品の説明<span
                                    class="badge badge-danger shadow-none ml-2">必須</span></label>
                        ...
                        <div class="card-body pt-3">
                            ...
                            {{-- カテゴリーセレクト --}}
                            <label class="font-weight-bold">カテゴリー<span
                                    class="badge badge-danger shadow-none ml-2">必須</span></label>
                            <div>
                            ...
                            {{-- 商品状態セレクト --}}
                            <label class="font-weight-bold mt-4 pt-4">商品の状態<span
                                    class="badge badge-danger shadow-none ml-2">必須</span></label>
                            <div>
                        ...
                        <div class="card-body pt-3">
                            ...
                            {{-- 送料負担セレクト --}}
                            <label class="font-weight-bold">配送料の負担<span
                                    class="badge badge-danger shadow-none ml-2">必須</span></label>
                            <div>
                            ...
                            {{-- 発送地域セレクト --}}
                            <label class="font-weight-bold mt-4 pt-4">発送元の地域<span
                                    class="badge badge-danger shadow-none ml-2">必須</span></label>
                            <div>
                            ...
                            {{-- 発送日数セレクト --}}
                            <label class="font-weight-bold mt-4 pt-4">発送までの日数<span
                                    class="badge badge-danger shadow-none ml-2">必須</span></label>
                            <div>
                        ...
                        <div class="form-group row">
                            ...
                            {{-- 開始価格 --}}
                            <label for="value"
                                class="col-md-6 col-form-label text-md-left-3 ml-4 font-weight-bold">開始価格<span
                                    class="badge badge-danger shadow-none ml-2">必須</span></label>
