                ...
                <section class="text-center">
                  ...
                  <div class="row">
                      ...
                      <div class="row w-100 ml-4 pl-5 mt-4">
                          <!-- Grid column -->
                            <div class="col-md-4 pt-5">
                                ...
                                <img src="{{ asset('storage/image/1.jpg') }}" class="z-depth-1 rounded-circle img-fluid" alt="smaple image">
                                </div>
                            ...
                            <div class="col-md-4 mb-4 pt-5">
                                ...
                                <div class="w-100 mx-auto mb-4">
                                <img src="{{ asset('storage/image/2.jpg') }}" class="z-depth-1 rounded-circle img-fluid mx-auto" alt="smaple image">
                                </div>
                            ...
                            <div class="col-md-4 mb-4 pt-5">
                                ...
                                <div class="w-100 mx-auto mb-4">
                                <img src="{{ asset('storage/image/3.jpg') }}" class="z-depth-1 rounded-circle img-fluid mx-auto" alt="smaple image">
                                </div>
                    ...
                    <div class="col-lg-3 text-center text-md-left mt-2 pt-2">
                      ...
                      <h2 class="h2-responsive text-center product-name font-weight-bold dark-grey-text mb-1 pr-1 mt-4 h4">現在価格</h2>
                      ...
                      <h2 class="h2-responsive text-center product-name font-weight-bold dark-grey-text mb-1 pr-1 h4">残り時間</h2>
                      ...
                      <h3 class="h3-responsive text-center  mb-5 pr-1">
                        ...
                        <form action="">
                            ...
                            <div class="row ml-4">
                                <div class="col-10">
                                    <label>入札金額</label>
                                    <input id="number" type="number" class="form-control w-100" name="price" value="{{ old('price') }}" placeholder="￥0" min="300" max="9999999"  required>
