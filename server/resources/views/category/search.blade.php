                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card card-ecommerce">
                        <div class="view overlay ml-1">
                            <img src="{{ asset('storage/' . $sell->imgpath) }}" class="img-fluidincart ml-4 mt-3"
                                ...
                                <div class="row mb-0">
                                    <span class="float-left">
                                        ...
                                        <form action="{{ url('/mypage/like') }}" method="POST" class="float-right ml-5">
                                            ...
                                            <button type="submit"
                                                class="btn btn-sm btn-link rounded-pill border-danger text-danger nav-link"><i
                                                    class="far fa-heart text-danger pr-1"></i>いいね！</button>
                                        </form>
                                    </span>
                                </div>
                            </div>
