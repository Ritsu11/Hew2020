                            ...
                            <form action="/profile" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card shadow-none border-0 pb-4">
                                    <div class="card-body pt-3">
                                        ...
                                        {{-- 名前 --}}
                                        <label class="font-weight-bold">ニックネーム<span class="badge badge-danger shadow-none ml-2">必須</span></label>
                                        <input type="text" class="form-control" name="name" placeholder="例）HAL太郎" value="{{ $user->name }}" required>
                                        <div class="pt-2">
