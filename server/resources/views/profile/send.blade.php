                    ...
                    <form action="/profile/send" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card shadow-none border-0 pb-4">
                            <div class="card-body pt-3">
                                ...
                                <input type="text" class="form-control" name="firstname" placeholder="例）山田" value="{{ $user->firstname }}" required>
                                    <div class="pt-2">
                                        <span class="help-block h6 text-danger">{{$errors->first('firstname')}}</span>
                                    </div>
                                <input type="text" class="form-control" name="lastname" placeholder="例）太郎" value="{{ $user->lastname }}" required>
                                <div class="pt-2">
                                    <span class="help-block h6 text-danger">{{$errors->first('lastname')}}</span>
                                </div>
                            </div>
                            ...
                            <div class="card-body pt-3">
                                ...
                                <input type="text" class="form-control" name="firstname_kana" placeholder="例）ヤマダ" value="{{ $user->firstname_kana }}" required>
                                    <div class="pt-2">
                                        <span class="help-block h6 text-danger">{{$errors->first('firstname_kana')}}</span>
                                    </div>
                                <input type="text" class="form-control" name="lastname_kana" placeholder="例）タロウ" value="{{ $user->lastname_kana }}" required>
                                <div class="pt-2">
                                    <span class="help-block h6 text-danger">{{$errors->first('lastname_kana')}}</span>
                                </div>
                            </div>
                            ...
                            <div class="h-adr">
                                ...
                                <div class="card-body pt-3">
                                    ...
                                    <input type="text" class="form-control p-postal-code" name="postal_code" placeholder="例）123-4567" value="{{ $user->postal_code }}" size="7" maxlength="7" required>
                                        <div class="pt-2">
                                            <span class="help-block h6 text-danger">{{$errors->first('postal_code')}}</span>
                                        </div>
                                </div>
                                ...
                                <div class="card-body pt-3">
                                    ...
                                    <input type="text" class="form-control p-locality p-street-address p-extended-address" name="city" placeholder="例）新宿区" value="{{ $user->city }}" required>
                                        <div class="pt-2">
                                            <span class="help-block h6 text-danger">{{$errors->first('city')}}</span>
                                        </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body pt-3">
                                ...
                                <input type="text" class="form-control" name="city_address" placeholder="例）新宿1-7-3" value="{{ $user->city_address }}" >
                                    <div class="pt-2">
                                        <span class="help-block h6 text-danger">{{$errors->first('city_address')}}</span>
                                    </div>
                            </div>
