                    ...
                    <form action="/profile/send" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card shadow-none border-0 pb-4">
                            ...
                            <div class="card-body pt-3">
                                ...
                                <input type="text" class="form-control" name="postal_code" placeholder="例）123-4567" value="{{ $user->postal_code }}" required>
                                    <div class="pt-2">
                            ...
                            <div class="card-body pt-3">
                                ...
                                <input type="text" class="form-control" name="city" placeholder="例）新宿区" value="{{ $user->city }}" required>
                                    <div class="pt-2">
                            ...
                            <div class="card-body pt-3">
                                ...
                                <input type="text" class="form-control" name="city_address" placeholder="例）新宿1-7-3" value="{{ $user->city_address }}" required>
                                    <div class="pt-2">
